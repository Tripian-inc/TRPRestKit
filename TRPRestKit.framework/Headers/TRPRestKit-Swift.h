...
/// <ul>
///   <li>
///     See Also: <a href="https://github.com/Tripian-inc/TRPRestKit">How to use</a>
///   </li>
///   <li>
///     See Also: <a href="http://airmiles-api-1837638174.ca-central-1.elb.amazonaws.com/apidocs/#tripian-recommendation-engine">Api Doc</a>
///   </li>
/// </ul>
/// \code
///
...
///
///
/// \endcodeA <code>TRPRestKit()</code> object  defines a single object that user can follow to operate below functions.
...
/// such as <code>TRPRestKit().city(withId:completion:)</code> method. However assure that you have provided tripian api key first.
